...
<br>
<br>
더 빠른 안내를 위하여 판매자 현금거래 유도 관련 문의는 
<br>
<b>올쇼핑 사기거래 신고센터 (02-2621-4699)</b>로 연락해 주시기 바랍니다.</p>
</div>
<br>
<h2>[ 자주 묻는 질문 ]</h2>
<br>
	...
	<br>
		...
		{{#each array}}
			<div class="replyBox2" style="overflow:hidden;font-size:15px;" writer={{writer}} rn={{rn}} qid={{qid}}>
					...
					<b>질문 :</b> 
					<input type="text" class="replyContent2" writer={{writer}} value="{{content}}" style="width:600px;text-align:center;background:none; border:2px solid lightgrey; border-radius:0px; margin:10px;" disabled/>
					<br>
					...
					<div class="answerBox" style="float:left;padding-left:15px;" answer={{answer}} >
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						
						<b>ㄴ 답변 : </b> 
						<input type="text" class="answerContent2" writer={{writer}} value="{{answer}}" style="width:600px;text-align:center;background:none; border:2px solid lightgrey; border-radius:0px; margin:10px;" disabled/>
						<span class="answerTime" style="display:none;font-size:10px;"></span>
						&nbsp;
