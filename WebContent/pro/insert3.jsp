...
<script>
	...
	$(frm.mall_id).on("click",function(){
		window.open("/mall/listAll3.jsp","mall_id","width=850,height=400,top=200,right=600");
	});
	$(frm.mall_name).on("click",function(){
		window.open("/mall/listAll3.jsp","mall_name","width=850,height=400,top=200,right=600");
	});
</script>