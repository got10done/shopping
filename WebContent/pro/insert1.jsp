...
<form name="frm" enctype="multipart/form-data">
     <table>
        ...
        <tr>
           <td width=210 class="title">업체정보</td>
        ...
        <tr>
           <td width=180 class="title">상품이름</td>
...
<script>
	...
	$(frm.mall_id).on("click",function(){
		window.open("/mall/listAll1.jsp","mall_id","width=850,height=400,top=200,right=600");
	});
	$(frm.mall_name).on("click",function(){
		window.open("/mall/listAll1.jsp","mall_name","width=850,height=400,top=200,right=600");
	});
